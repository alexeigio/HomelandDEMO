                        ...
                        <div class="property-entry h-100">
                            <a href="{{ route('property_details',$prop->id) }}" class="property-thumbnail">
                                <div class="offer-type-wrap">
                                    <span class="offer-type bg-danger">{{$prop->offer_type}}</span>
                            ...
                            <div class="p-4 property-body">
                                ...
                                <h2 class="property-title"><a href="property-details.html">{{ $prop->address }}</a>
                                </h2>
                                <span class="property-location d-block mb-3"><span class="property-icon icon-room"></span>
                                {{$prop->description}}</span>
                                <strong class="property-price text-primary mb-3 d-block text-success">$ {{ number_format($prop->price, 2, '.', ',') }}</strong>
